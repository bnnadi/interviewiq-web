...
const DashboardPage: React.FC = () => {
  const { handleStartNewInterview, handleViewSessions, handleViewAnalytics } = useAppContext()
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card className="p-4 text-center">
          <div className="text-2xl font-bold text-green-600">{mockStats.averageScore}</div>
          <div className="text-sm text-gray-600">Average Score</div>
        </Card>
        <Card className="p-4 text-center">
          <div className="text-2xl font-bold text-purple-600">+{mockStats.improvementRate}%</div>
